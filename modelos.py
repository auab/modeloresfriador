...
def solve_one_dimensional_diffusion_convection(material_props, mesh, west_bound,
                                               ...
                                               velocity_field=None):
    velocity_field, external_convection, volumetric_source = initialize_one_dimensional_solver(velocity_field,
                                                                                               external_convection,
                                                                                               volumetric_source)
    n_x = int(mesh["L_x"] / mesh["d_x"])

    thermal_resist, vol_heat_source, convection_resist, F_e, F_w = define_equation_components(n_x, mesh, material_props,
                                                                                              volumetric_source,
                                                                                              velocity_field,
                                                                                              external_convection)
...
def initialize_one_dimensional_solver(velocity_field, external_convection, volumetric_source):
...
def define_equation_components(n_x, mesh, material_props, volumetric_source, velocity_field, external_convection):
